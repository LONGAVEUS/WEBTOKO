...
<div class="container mx-auto p-4 space-y-6">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                placeholder="Ketik nama produk" required>
                        </div>
                        <div class="col-span-2">
                            <label for="harga"
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="4"
                                ...
                                placeholder="Tulis deskripsi lengkap produk di sini" required></textarea>
                        </div>
                    </div>
                    <button type="submit"
    ...
    <div class="overflow-x-auto bg-white rounded-lg shadow-sm border border-gray-200">
        <table class="min-w-full table-auto text-sm text-left">
            <thead>
                <tr
                    class="bg-gray-100 text-gray-700 uppercase text-xs font-bold tracking-wider border-b border-gray-200">
